...
void main() {
  ...
  testWidgets('Counter decrements when button is pressed', (WidgetTester tester) async {
    await tester.pumpWidget(
      const ProviderScope(
        child: RiverpodExampleApp(),
      ),
  ...
  testWidgets('Counter resets when reset button is pressed', (WidgetTester tester) async {
    await tester.pumpWidget(
      const ProviderScope(
        child: RiverpodExampleApp(),
      ),
  ...
  testWidgets('Add sample todo button works', (WidgetTester tester) async {
    await tester.pumpWidget(
      const ProviderScope(
        child: RiverpodExampleApp(),
      ),
