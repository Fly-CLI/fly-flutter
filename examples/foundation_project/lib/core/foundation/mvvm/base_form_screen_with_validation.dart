...
import 'package:foundation_project/core/foundation/forms/form_view_model_interface.dart';
...
>
  ...
  ValidationResult validateForm(V viewModel) {
    final formViewModel = viewModel as dynamic;
    final controller = formViewModel.formController;
    if (controller != null && controller is FormController) {
      return controller.validateAll();
    }
  ...
  String getSubmitButtonText(BuildContext context) {
    ...
    return item != null ? l10n.update : l10n.add;
  }
