...
import 'package:foundation_project/core/foundation/mvvm/services/default_navigation_service.dart';

/// Provider for NavigationService
///
/// Default implementation uses standard Flutter Navigator.
/// Override this provider to use custom routing libraries (go_router, auto_route, etc.).
///
