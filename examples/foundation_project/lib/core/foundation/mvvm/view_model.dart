...
abstract class ViewModel<T extends ViewModelState> extends Notifier<T>
  ...
  /// feedback emission. It uses [AsyncHandler] internally for network-aware async
  ...
  ///
  /// The [timeout] parameter defaults to [AsyncHandlerConfig.standardTimeout] (30 seconds)
  /// if not specified. For long-running operations, consider using:
  /// - [AsyncHandlerConfig.longTimeout] (60 seconds)
  /// - [AsyncHandlerConfig.veryLongTimeout] (120 seconds)
  /// - [AsyncHandlerConfig.backgroundTimeout] (100 minutes)
  ///
  /// Example:
  /// ```dart
  ...
  Future<AppResult<R>> performAsync<R>(
    ...
    final result = await _asyncHandler.performAsync(
      ...
      timeout: timeout ?? AsyncHandlerConfig.standardTimeout,
