...
**Context Export**: `fly context` generates project-specific context for AI assistants
...
# Export to file
fly context --file=context.json

# Include source code
fly context --include-code

# Include dependencies
fly context --include-dependencies

# Full export
fly context --file=context.json --include-code --include-dependencies
```
...
2. Export context: `fly context --include-code --include-dependencies`
...
- Export context: `fly context --include-code --include-dependencies`
