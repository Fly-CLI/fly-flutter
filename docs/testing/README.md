...
This directory contains documentation and guides for testing Fly CLI features through natural usage
scenarios.
...
see [AI-Assisted Development Guide](./ai-assisted-development.md) for the complete workflow.
...
- **[AI Testing Guide](./ai-testing-guide.md)** - Comprehensive guide for AI assistants to test Fly
  CLI via MCP protocol
- **[AI-Assisted Development](./ai-assisted-development.md)** - Workflow guide for developers using
  AI assistants (Cursor) during CLI development

## Test Project

The test project at `examples/test_project/` serves as a dedicated Flutter project for validating
Fly CLI capabilities. It includes:
