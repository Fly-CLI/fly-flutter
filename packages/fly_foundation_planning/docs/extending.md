...
This guide explains how to add new bricks, workflows, and capabilities to the planning system.
...
If you want automatic inference, update `PlanningRequest._inferWorkflowId()`:
...
2. **Integration Tests**: Test full planning pipeline
