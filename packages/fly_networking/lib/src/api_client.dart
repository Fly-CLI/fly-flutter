...
@riverpod
ApiClient defaultApiClient(DefaultApiClientRef ref) {
  final client = ref.watch(apiClientProvider);
  
  // Configure default settings
  client.configureTimeout(const Duration(seconds: 30));
...
ApiClient configuredApiClient(
  ...
  if (headers != null) {
    client.configureHeaders(headers);
  }
