...
import 'package:fly_errors/src/error_handler.dart';
...
class ErrorMessageFormatter {
  ...
  String format(
    ...
    // Handle Dart's built-in TimeoutException (from dart:async)
  ...
  bool isTimeoutError(Object error) {
    // Check for Dart's built-in TimeoutException (from dart:async)
    if (error is async.TimeoutException) {
      return true;
    }
    // Check for custom TimeoutException from error_handler.dart (extends AppException)
