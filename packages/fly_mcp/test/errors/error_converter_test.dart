  ...
  group('ErrorConverter', () {
    group('toJsonRpcError', () {
      ...
      test('should convert ToolNotFoundError', () {
        ...
        final result =
            ErrorConverter.toJsonRpcError(error, requestId: requestId);
      ...
      test(
          'should convert InvalidParamsError with both missing and invalid fields',
          () {
      ...
      test('should convert CancellationError', () {
        ...
        final result =
            ErrorConverter.toJsonRpcError(error, requestId: errorRequestId);
      ...
      test('should convert unknown errors to internal error', () {
        ...
        expect(result.data,
            containsPair('error', contains('Unknown error occurred')));
        expect(result.data, containsPair('requestId', requestId));
      });
