...
class MockScaffoldPagePromptStrategy extends PromptStrategy {
  ...
  Future<GetPromptResult> getPrompt(Map<String, Object?> params) async {
    ...
    final template =
        'Create a Flutter page named "$name" using $state. Include a widget, route, and basic tests.';
...
class MockPromptStrategyRegistryProvider
    implements PromptStrategyRegistryProvider {
  final Map<PromptType, PromptStrategy> _strategies = {
    PromptType.scaffoldFeature: MockScaffoldPagePromptStrategy(),
  };
