...
class StdioTransport {
  ...
  Stream<String> _framedMessages(Stdin input,
      {required int maxMessageBytes}) async* {
    final bytes = <int>[];
  ...
  ///
  /// All error messages are prefixed with `[fly_mcp]` for easy
  ...
  void _logErr(String message) {
    (_stderr ?? stderr).writeln('[fly_mcp] $message');
  }
}
