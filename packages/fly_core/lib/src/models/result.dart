...
extension ResultHelpers<T> on Result<T> {
  ...
  Result<R> mapValue<R>(R Function(T data) mapper) => switch (this) {
  ...
  Result<T> recover(Result<T> Function(Object error, StackTrace? stackTrace) recovery) => switch (this) {
      Success<T>() => this,
  ...
  Result<T> recoverWith(T Function(Object error, StackTrace? stackTrace) recovery) => switch (this) {
      Success<T>() => this,
      Failure<T>(error: final error, stackTrace: final stackTrace) => 
