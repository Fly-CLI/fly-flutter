...
abstract class BaseScreen<T, VM extends BaseViewModel<T>> 
  ...
  /// Create the ViewModel for this screen
  VM createViewModel();
  ...
  @override
  State<BaseScreen<T, VM>> createState() => _BaseScreenState<T, VM>();
}

class _BaseScreenState<T, VM extends BaseViewModel<T>> 
    extends State<BaseScreen<T, VM>> {
  ...
  void initState() {
    ...
    widget.onInitialize(_viewModel);
  ...
  void _handleStateChange() {
    ...
    if (_previousState != currentState) {
      ...
      if (mounted) {
        widget.onStateChanged(_viewModel, currentState);
        setState(() {});
      }
    }
  }
