    ...
    group('render', () {
      ...
      group('nested structures', () {
        ...
        test('should handle nested sections with outer true inner false', () {
          final template = '{{#outer}}{{#inner}}Both true{{/inner}}{{^inner}}Only outer{{/inner}}{{/outer}}';
      ...
      group('real-world patterns', () {
        test('should handle fix_lints pattern', () {
          final template = 'Analyze{{#lintFile}} {{lintFile}}{{/lintFile}}{{^lintFile}} all files{{/lintFile}}';
        ...
        test('should handle scaffold_api_client pattern', () {
          final template = '''{{#isBearerAuth}}Bearer token{{/isBearerAuth}}{{^isBearerAuth}}{{#isBasicAuth}}Basic auth{{/isBasicAuth}}{{^isBasicAuth}}No auth{{/isBasicAuth}}{{/isBearerAuth}}''';
