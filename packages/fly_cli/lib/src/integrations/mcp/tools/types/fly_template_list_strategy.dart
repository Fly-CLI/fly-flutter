...
import 'package:fly_cli/src/integrations/mcp/tools/types/fly_template_list_params.dart';
import 'package:fly_cli/src/integrations/mcp/tools/types/fly_template_list_result.dart';
import 'package:fly_mcp/fly_mcp.dart';

/// Strategy for fly.template.list tool
class FlyTemplateListStrategy
    extends McpToolStrategy<FlyTemplateListParams, FlyTemplateListResult> {
  @override
