...
import 'package:fly_cli/src/integrations/mcp/tools/types/template_apply_params.dart';
import 'package:fly_cli/src/integrations/mcp/tools/types/template_apply_result.dart';
import 'package:fly_cli/src/integrations/mcp/utils/progress_helpers.dart';
import 'package:fly_mcp/fly_mcp.dart';

/// Strategy for fly.template.apply tool
class TemplateApplyStrategy
    extends McpToolStrategy<TemplateApplyParams, TemplateApplyResult> {
  @override
  ...
  @override
  TemplateApplyParams paramsFromJson(Map<String, Object?> json) {
    return TemplateApplyParams.fromJson(json);
  }
