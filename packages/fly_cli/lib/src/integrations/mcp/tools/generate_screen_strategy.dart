...
import 'package:fly_cli/src/integrations/mcp/tools/types/generate_screen_result.dart';
import 'package:fly_mcp/fly_mcp.dart';

/// Strategy for fly.generate.screen tool
class GenerateScreenStrategy
    extends McpToolStrategy<GenerateScreenParams, GenerateScreenResult> {
  @override
  ...
  @override
  GenerateScreenParams paramsFromJson(Map<String, Object?> json) {
    return GenerateScreenParams.fromJson(json);
  }
  ...
  TypedToolHandler<GenerateScreenParams, GenerateScreenResult>
    ...
    return (params, {cancelToken, progressNotifier}) async {
      ...
      return GenerateScreenResult(
        ...
        screenPath: Directory.current.path,
      );
    };
  }
}
