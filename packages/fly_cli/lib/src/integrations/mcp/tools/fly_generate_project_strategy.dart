...
import 'package:fly_cli/src/integrations/mcp/tools/types/fly_generate_project_params.dart';
import 'package:fly_cli/src/integrations/mcp/tools/types/fly_generate_project_result.dart';
import 'package:fly_mcp/fly_mcp.dart';

/// Strategy for fly.generate.project tool
class FlyGenerateProjectStrategy extends McpToolStrategy<
    FlyGenerateProjectParams, FlyGenerateProjectResult> {
  @override
  ...
  ObjectSchema get paramsSchema => ObjectSchema(
        ...
        properties: {
          ...
          'features': Schema.list(
            items: Schema.string(),
            description:
                'Initial features to scaffold in the project. Optional list of feature names.',
          ),
  ...
  @override
  FlyGenerateProjectParams paramsFromJson(Map<String, Object?> json) {
    return FlyGenerateProjectParams.fromJson(json);
  }

  @override
  TypedToolHandler<FlyGenerateProjectParams, FlyGenerateProjectResult>
      createTypedHandler(
    ...
    return (params, {cancelToken, progressNotifier}) async {
      ...
      // Create orchestrator for project generation
      final orchestrator = TemplateGenerationOrchestrator(
        templateManager: context.templateManager,
        logger: context.logger,
      );

      // Create unified generation service with orchestrator
      ...
      // Generate project using unified service
      ...
      return FlyGenerateProjectResult(
        ...
        projectPath: result.targetDirectory ?? projectPath.absolute,
      );
    };
  }
}
