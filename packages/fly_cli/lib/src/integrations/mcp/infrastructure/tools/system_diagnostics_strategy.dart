...
import 'package:fly_cli/src/integrations/mcp/infrastructure/tools/types/doctor_params.dart';
import 'package:fly_cli/src/integrations/mcp/infrastructure/tools/types/doctor_result.dart';
import 'package:fly_mcp/fly_mcp.dart';

/// Strategy for fly.doctor tool
class SystemDiagnosticsStrategy
    extends McpToolStrategy<DoctorParams, DoctorResult> {
  @override
  ...
  @override
  DoctorParams paramsFromJson(Map<String, Object?> json) {
    return DoctorParams.fromJson(json);
  }

  @override
  TypedToolHandler<DoctorParams, DoctorResult> createTypedHandler(
