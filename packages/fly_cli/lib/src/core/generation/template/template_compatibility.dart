...
/// JSON converter for Version (nullable)
...
/// JSON converter for Version (non-nullable)
class NonNullableVersionConverter implements JsonConverter<Version, String> {
  const NonNullableVersionConverter();
