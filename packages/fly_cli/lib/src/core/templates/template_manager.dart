...
/// Template generation result (for low-level brick generation API)
///
/// This is kept for backward compatibility with generateFromBrick().
/// For new code, use TemplateGenerationOrchestrator instead.
