...
import 'package:fly_cli/src/core/scaffolding/generation/generation_request.dart'
    show GenerationRequest, GenerationType;
...
import 'package:fly_cli/src/core/scaffolding/variables/variable_derivers/foundation_pipeline.dart';
...
class GenerationService {
  ...
  Future<GenerationResult> generate({
    ...
    try {
      ...
      final brick = await _templateManager.getBrick(brickName);
      if (brick == null) {
