...
import 'package:fly_cli/src/features/mcp/tools/types/fly_context_export_params.dart';
import 'package:fly_cli/src/features/mcp/tools/types/fly_context_export_result.dart';
import 'package:fly_mcp_server/fly_mcp_server.dart';

/// Strategy for fly.context.export tool
class FlyContextExportStrategy
    extends McpToolStrategy<FlyContextExportParams, FlyContextExportResult> {
  @override
  ...
  @override
  FlyContextExportParams paramsFromJson(Map<String, Object?> json) {
    return FlyContextExportParams.fromJson(json);
  }

  @override
  TypedToolHandler<FlyContextExportParams, FlyContextExportResult>
      createTypedHandler(
    ...
    return (params, {cancelToken, progressNotifier}) async {
      ...
      final contextData =
          await contextGenerator.generate(projectDir, config);
      ...
      if (params.outputFile != null) {
        ...
        await file.writeAsString(
            _formatOutput(contextData)); // TODO: Proper JSON formatting
