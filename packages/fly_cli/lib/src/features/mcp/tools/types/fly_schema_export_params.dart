...
class FlySchemaExportParams extends ToolParameter {
  FlySchemaExportParams({
    this.format,
    this.command,
    this.outputFile,
  ...
  factory FlySchemaExportParams.fromJson(Map<String, Object?> json) {
    return FlySchemaExportParams(
  ...
  Map<String, Object?> toJson() => {
        ...
        if (includeGlobalOptions != null) 'includeGlobalOptions': includeGlobalOptions,
