...
import '../../../core/command_foundation/application/command_base.dart';
import '../domain/command_definition.dart';
...
class MetadataExtractor {
  ...
  /// Extract global options from CommandRunner's ArgParser
  List<OptionDefinition> extractGlobalOptions(CommandRunner<int> runner) =>
      _extractOptions(runner.argParser, isGlobal: true);
}
