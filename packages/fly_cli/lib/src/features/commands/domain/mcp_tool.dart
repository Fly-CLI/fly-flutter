...
extension McpToolExtension on McpTool {
  ...
  McpToolStrategy get _strategy {
    // Use the global registry instance from mcp_tool_strategy_registry.dart
    final registry = McpToolStrategyRegistry();
    return registry.getStrategy(this);
  }
