...
class CachedTemplate {
  ...
  CachedTemplate withNewExpiration(int daysFromNow) {
...
class CacheMetadata {
  ...
  bool get needsCleanup {
    return DateTime.now().difference(lastCleanup).inDays >= 1;
  }
...
class CacheEntry {
  ...
  bool get isStale {
    return DateTime.now().difference(lastAccessed).inDays > 30;
  }
}
