# StarterApp Project Context

This document provides context about the StarterApp project for AI-assisted development.

## Project Overview

**Name**: StarterApp
**Description**: Minimal Fly foundation project without tests
