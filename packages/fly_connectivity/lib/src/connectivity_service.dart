...
import 'package:fly_connectivity/src/connectivity_checker.dart';
...
/// 
/// Uses [ConnectivityChecker] interface for pluggable connectivity
/// implementations.
/// 
/// Applications must provide a [ConnectivityChecker] implementation.
class ConnectivityService {
  /// Creates a [ConnectivityService] with the provided checker and logger.
  ///
  /// [checker] - The connectivity checker implementation
  /// [logger] - The logger instance for logging connectivity events
  ConnectivityService({
