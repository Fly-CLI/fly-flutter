...
void main() {
  group('AsyncValueExtension', () {
    test('should check loading state', () {
      ...
      expect(asyncValue.isFlyLoading, true);
      expect(asyncValue.hasFlyData, false);
      expect(asyncValue.hasFlyError, false);
    });

    test('should check data state', () {
      const asyncValue = AsyncValue<String>.data('test');
      expect(asyncValue.isFlyLoading, false);
      expect(asyncValue.hasFlyData, true);
      expect(asyncValue.hasFlyError, false);
    ...
    test('should check error state', () {
      ...
      expect(asyncValue.isFlyLoading, false);
      expect(asyncValue.hasFlyData, false);
      expect(asyncValue.hasFlyError, true);
  ...
  group('AsyncValueListExtension', () {
    ...
    test('should filter list', () {
      ...
      final filtered = asyncValue.where((e) => e.isEven);
      expect(filtered.hasFlyData, true);
    ...
    test('should reverse list', () {
      ...
      expect(reversed.hasFlyData, true);
    ...
    test('should skip elements', () {
      ...
      expect(skipped.hasFlyData, true);
    ...
    test('should get sublist', () {
      ...
      expect(sublist.hasFlyData, true);
  ...
  group('AsyncValueMapExtension', () {
    ...
    test('should get entries', () {
      ...
      expect(entries.hasFlyData, true);
    ...
    test('should filter map', () {
      ...
      final filtered = asyncValue.where((key, value) => value.isEven);
      expect(filtered.hasFlyData, true);
