...
void main() {
  group('BrickComposer', () {
    ...
    test('throws error for invalid service type combination', () {
      ...
      expect(
        () => composer.composeBricks(rawVars, TestWorkflowIds.serviceWorkflow),
        throwsA(isA<ComposerException>()),
      );
    });
...
class TestLogger implements ComposerLogger {
