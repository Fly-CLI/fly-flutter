...
case "$CATEGORY" in
  ...
  development)
    ...
    echo "  ./scripts/development/reload-cli.sh      - Reload CLI after code changes"
    echo "  ./scripts/development/dev-cycle.sh       - Complete development cycle"
  ...
  mcp)
    ...
    echo "  ./scripts/mcp/list.sh             - List tools, prompts, and resources"
    echo "  ./scripts/mcp/validate.sh         - Validate tools, prompts, and resources"
    echo ""
    echo "For help on a specific script:"
